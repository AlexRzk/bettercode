...
Desktop application and browser-based app issues, including `bettercode web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core bettercode server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

BetterCode Zen, BetterCode Go, and billing issues.
