...
Use this folder for locale-specific translation guidance that supplements `.bettercode/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/bettercode/pull/12345

## Do Not Translate (Locale Additions)

- `BetterCode` (preserve casing)
