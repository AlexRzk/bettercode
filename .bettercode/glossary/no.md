...
- PR #10018: https://github.com/anomalyco/bettercode/pull/10018
- PR #12935: https://github.com/anomalyco/bettercode/pull/12935

## Do Not Translate (Locale Additions)

- `BetterCode` (preserve casing in prose; keep `bettercode` only in commands, package names, paths, or code)
- `BetterCode CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
