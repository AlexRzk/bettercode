...
- PR #15835: https://github.com/anomalyco/bettercode/pull/15835

## Do Not Translate (Locale Additions)

- `BetterCode` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `bettercode` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `BetterCode` in prose, `bettercode` only for exact technical identifiers
...
- Avoid changing `bettercode` to `BetterCode` inside commands, URLs, package names, or code literals
