...
- PR #13942: https://github.com/anomalyco/bettercode/pull/13942

## Do Not Translate (Locale Additions)

- `BetterCode` (preserve casing in prose; keep `bettercode` only when it is part of commands, package names, paths, or code)
- `BetterCode Zen`
- `BetterCode CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `bettercode` in prose when referring to the product name; use `BetterCode`
