...
beforeAll(async () => {
  ...
  mock.module("@bettercode/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@bettercode/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@bettercode/ui/icon", () => ({ Icon: () => null }))
  mock.module("@bettercode/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
