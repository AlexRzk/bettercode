...
import { Tooltip, TooltipKeybind } from "@bettercode/ui/tooltip"
import { useTheme } from "@bettercode/ui/theme/context"
import { IconButtonV2 } from "@bettercode/ui/v2/icon-button-v2"
import { Icon as IconV2 } from "@bettercode/ui/v2/icon"
import { KeybindV2 } from "@bettercode/ui/v2/keybind-v2"
import { TooltipV2 } from "@bettercode/ui/v2/tooltip-v2"
...
import { base64Encode } from "@bettercode/core/util/encode"
import { ProjectAvatar } from "@bettercode/ui/v2/project-avatar-v2"
        ...
        <Match when>
          ...
          >
              ...
              <div class="flex items-center gap-1 shrink-0">
                ...
                <div class="hidden xl:flex items-center shrink-0">
                  ...
                  >
                    ...
                    <div id="bettercode-titlebar-left" class="flex items-center gap-3 min-w-0 px-2" />
                    <ChannelIndicator />
                  </div>
                </div>
              </div>
            ...
            <div
              ...
              onMouseDown={drag}
            >
              <div id="bettercode-titlebar-right" class="flex items-center gap-1 shrink-0 justify-end" />
              <Show when={windows()}>
...
function TitlebarV2Right(props: { state: TitlebarV2RightState }) {
  return (
    <div class="relative z-20 flex shrink-0 items-center justify-end gap-0 overflow-visible">
      ...
      <div id="bettercode-titlebar-right" class="flex shrink-0 items-center justify-end gap-0" />
    </div>
  )
}
...
function ChannelIndicator() {
  return (
    <>
      {["beta", "dev"].includes(import.meta.env.VITE_BETTERCODE_CHANNEL) && (
        <div class="bg-icon-interactive-base text-[#FFF] font-medium px-2 rounded-sm uppercase font-mono">
          {import.meta.env.VITE_BETTERCODE_CHANNEL.toUpperCase()}
        </div>
      )}
    </>
  )
