export const dict = {
  ...
  "dialog.provider.bettercode.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.bettercode.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.bettercodeGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo BetterCode",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no BetterCode.",
  ...
  "provider.connect.bettercodeZen.line1":
    "BetterCode Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.bettercodeZen.visit.prefix": "Visite ",
  "provider.connect.bettercodeZen.visit.link": "bettercode.ai/zen",
  "provider.connect.bettercodeZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no BetterCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no BetterCode.",
  ...
  "dialog.plugins.empty": "Plugins configurados em bettercode.json",
  ...
  "dialog.server.description": "Trocar para qual servidor BetterCode este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do BetterCode ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do BetterCode",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (bettercode.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: BetterCode ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "BetterCode inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor BetterCode dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do BetterCode",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o BetterCode aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o BetterCode segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o BetterCode é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o BetterCode iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do BetterCode.",
