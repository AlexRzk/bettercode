export const dict = {
  ...
  "dialog.provider.bettercode.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.bettercode.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.bettercodeGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje BetterCode",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u BetterCode-u.",
  ...
  "provider.connect.bettercodeZen.line1":
    "BetterCode Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.bettercodeZen.visit.prefix": "Posjeti ",
  "provider.connect.bettercodeZen.visit.link": "bettercode.ai/zen",
  "provider.connect.bettercodeZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u BetterCode-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u BetterCode-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u bettercode.json",
  ...
  "dialog.server.description": "Promijeni na koji se BetterCode server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija BetterCode-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku BetterCode timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (bettercode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: BetterCode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "BetterCode uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni BetterCode server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u BetterCode-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako BetterCode izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li BetterCode prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu BetterCode-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se BetterCode pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju BetterCode-a.",
