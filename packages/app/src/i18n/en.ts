export const dict = {
  ...
  "dialog.provider.bettercode.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.bettercode.tagline": "Reliable optimized models",
  "dialog.provider.bettercodeGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by BetterCode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in BetterCode.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.bettercodeZen.line1":
    "BetterCode Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.bettercodeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.bettercodeZen.visit.prefix": "Visit ",
  "provider.connect.bettercodeZen.visit.link": "bettercode.ai/zen",
  "provider.connect.bettercodeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in BetterCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in BetterCode.",
  ...
  "dialog.plugins.empty": "Plugins configured in bettercode.json",
  ...
  "dialog.server.description": "Switch which BetterCode server this app connects to.",
  ...
  "wsl.onboarding.step.bettercode": "BetterCode",
  ...
  "wsl.onboarding.checkingOpencode": "Checking BetterCode...",
  "wsl.onboarding.checkingOpencodeIn": "Checking BetterCode in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating BetterCode...",
  "wsl.onboarding.updatingOpencodeIn": "Updating BetterCode in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update BetterCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update BetterCode",
  "wsl.onboarding.bettercodeReadyIn": "BetterCode is ready in {{distro}}.",
  "wsl.onboarding.bettercodeReady": "BetterCode is ready.",
  "wsl.onboarding.installOpencodeIn": "Install BetterCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install BetterCode",
  ...
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen BetterCode.",
  ...
  "toast.update.description": "A new version of BetterCode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the BetterCode team",
  ...
  "error.chain.checkConfig": "Check your config (bettercode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, BetterCode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "BetterCode includes free models so you can start immediately.",
  ...
  "app.name.desktop": "BetterCode Desktop",
  ...
  "settings.desktop.wsl.description": "Run the BetterCode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for BetterCode",
  ...
  "settings.general.row.appearance.description": "Customise how BetterCode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether BetterCode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how BetterCode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when BetterCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of BetterCode.",
