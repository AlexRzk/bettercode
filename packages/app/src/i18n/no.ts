...
export const dict = {
  ...
  "dialog.provider.bettercode.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.bettercode.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.bettercodeGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av BetterCode",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i BetterCode.",
  ...
  "provider.connect.bettercodeZen.line1":
    "BetterCode Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.bettercodeZen.visit.prefix": "Besøk ",
  "provider.connect.bettercodeZen.visit.link": "bettercode.ai/zen",
  "provider.connect.bettercodeZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i BetterCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i BetterCode.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i bettercode.json",
  ...
  "dialog.server.description": "Bytt hvilken BetterCode-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av BetterCode ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til BetterCode-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (bettercode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at BetterCode ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "BetterCode inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør BetterCode-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for BetterCode",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan BetterCode ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om BetterCode skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan BetterCode er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når BetterCode starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av BetterCode.",
