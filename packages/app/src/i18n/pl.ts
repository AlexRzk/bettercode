export const dict = {
  ...
  "dialog.provider.bettercode.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.bettercode.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.bettercodeGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez BetterCode",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w BetterCode.",
  ...
  "provider.connect.bettercodeZen.line1":
    "BetterCode Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.bettercodeZen.visit.prefix": "Odwiedź ",
  "provider.connect.bettercodeZen.visit.link": "bettercode.ai/zen",
  "provider.connect.bettercodeZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w BetterCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w BetterCode.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w bettercode.json",
  ...
  "dialog.server.description": "Przełącz serwer BetterCode, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja BetterCode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu BetterCode",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (bettercode.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "BetterCode zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla BetterCode",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd BetterCode na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy BetterCode ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw BetterCode.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania BetterCode",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji BetterCode.",
