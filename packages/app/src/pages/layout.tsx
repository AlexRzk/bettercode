...
import { ResizeHandle } from "@bettercode/ui/resize-handle"
import { Button } from "@bettercode/ui/button"
import { IconButton } from "@bettercode/ui/icon-button"
import { Tooltip } from "@bettercode/ui/tooltip"
import { DropdownMenu } from "@bettercode/ui/dropdown-menu"
import { Dialog } from "@bettercode/ui/dialog"
import { getFilename } from "@bettercode/core/util/path"
import { Session, type Message } from "@bettercode/sdk/v2/client"
...
import { toaster } from "@bettercode/ui/toast"
...
import { retry } from "@bettercode/core/util/retry"
...
import { useTheme, type ColorScheme } from "@bettercode/ui/theme/context"
...
export default function Layout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://bettercode.ai/desktop-feedback")}
      renderPanel={() =>
