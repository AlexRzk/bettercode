...
Concrete inventory of the remaining `makeRuntime(...)`-backed facades in `packages/bettercode`.
...
- [x] `../core/src/filesystem.ts` (`FileSystem`) - legacy bettercode service removed
