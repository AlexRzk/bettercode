...
Practical reference for the current tool-migration state in `packages/bettercode`.
...
Tool tests should use the existing Effect helpers in `packages/bettercode/test/lib/effect.ts`:
