...
import { AccountStateTable, AccountTable } from "@bettercode/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@bettercode/AccountRepo") {}
