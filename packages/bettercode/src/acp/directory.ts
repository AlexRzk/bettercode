...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@bettercode/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@bettercode/ACPDirectory") {}
