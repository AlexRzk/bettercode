...
import type { AssistantMessage as BetterCodeAssistantMessage, Message } from "@bettercode/sdk/v2"
...
export type AssistantTokenCost = Pick<BetterCodeAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<BetterCodeAssistantMessage, "role"> &
  Partial<Pick<BetterCodeAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@bettercode/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@bettercode/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@bettercode/ACPUsage") {}
