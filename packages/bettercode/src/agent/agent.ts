...
import { AbsolutePath, type DeepMutable } from "@bettercode/core/schema"
...
import { PluginBoot } from "@bettercode/core/plugin/boot"
...
export class Service extends Context.Service<Service, Interface>()("@bettercode/Agent") {}
          ...
          plan: {
            ...
            permission: Permission.merge(
              ...
              Permission.fromConfig({
                ...
                edit: {
                  "*": "deny",
                  [path.join(".bettercode", "plans", "*.md")]: "allow",
