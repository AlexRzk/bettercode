...
import { normalizePromptContent } from "@bettercode/tui/editor"
...
import { BETTERCODE_BASE_MODE, useBindings } from "@bettercode/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close BetterCode" } satisfies SlashOption,
    ]
