...
import type { Event, GlobalEvent, BettercodeClient } from "@bettercode/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@bettercode/RunStreamTransport") {}
