// Shared type vocabulary for the direct interactive mode (`bettercode --mini`).
//
...
import type { BettercodeClient, PermissionRequest, QuestionRequest, ToolPart } from "@bettercode/sdk/v2"
import type { TuiConfig } from "@bettercode/tui/config"
...
type PromptModel = Parameters<BettercodeClient["session"]["prompt"]>[0]["model"]
type PromptInput = Parameters<BettercodeClient["session"]["prompt"]>[0]

export type RunPromptPart = NonNullable<PromptInput["parts"]>[number]

export type RunCommand = NonNullable<Awaited<ReturnType<BettercodeClient["command"]["list"]>>["data"]>[number]

export type RunProvider = NonNullable<Awaited<ReturnType<BettercodeClient["provider"]["list"]>>["data"]>["all"][number]
...
export type RunAgent = NonNullable<Awaited<ReturnType<BettercodeClient["app"]["agents"]>>["data"]>[number]

type RunResourceMap = NonNullable<Awaited<ReturnType<BettercodeClient["experimental"]["resource"]["list"]>>["data"]>
...
export type PermissionReply = Parameters<BettercodeClient["permission"]["reply"]>[0]

export type QuestionReply = Parameters<BettercodeClient["question"]["reply"]>[0]

export type QuestionReject = Parameters<BettercodeClient["question"]["reject"]>[0]
