...
//
// The saved variant persists across sessions in ~/.local/state/bettercode/model.json
...
class Service extends Context.Service<Service, VariantService>()("@bettercode/RunVariant") {}
