...
import { EventSequenceTable, EventTable } from "@bettercode/core/event/sql"
...
export class Service extends Context.Service<Service, Interface>()("@bettercode/Workspace") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        BETTERCODE_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        BETTERCODE_WORKSPACE_ID: config.id,
        BETTERCODE_EXPERIMENTAL_WORKSPACES: "true",
