 ...
 *   "@bettercode/ServerAuthConfig",
 *   {
 *     password: Config.string("BETTERCODE_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("BETTERCODE_SERVER_USERNAME").pipe(Config.withDefault("bettercode")),
 *   },
 * ) {}
 *
