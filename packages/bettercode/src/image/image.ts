...
export class Service extends Context.Service<Service, Interface>()("@bettercode/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __BETTERCODE_PHOTON_WASM_PATH?: string }).__BETTERCODE_PHOTON_WASM_PATH =
