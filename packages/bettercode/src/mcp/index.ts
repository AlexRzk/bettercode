...
import { ConfigMCPV1 } from "@bettercode/core/v1/config/mcp"
...
const CLIENT_OPTIONS = {
  capabilities: {
    // https://github.com/anomalyco/bettercode/issues/11948
    // sampling: {},
    // https://github.com/anomalyco/bettercode/issues/23066
    // elicitation: {},
    // https://github.com/anomalyco/bettercode/issues/2308
    roots: {},
    // https://github.com/anomalyco/bettercode/issues/28567
    // tasks: {},
  },
...
function createClient(directory: string) {
  const client = new Client({ name: "bettercode", version: InstallationVersion }, CLIENT_OPTIONS)
...
export class Service extends Context.Service<Service, Interface>()("@bettercode/MCP") {}
            ...
            if (isAuthError) {
              if (lastError.message.includes("registration") || lastError.message.includes("client_id")) {
                ...
                return events
                  .publish(TuiEvent.ToastShow, {
                    title: "MCP Authentication Required",
                    message: `Server "${key}" requires authentication. Run: bettercode mcp auth ${key}`,
                    variant: "warning",
                    duration: 8000,
                  })
                  .pipe(Effect.ignore, Effect.as(undefined))
