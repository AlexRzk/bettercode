...
<html>
  <head>
    <title>BetterCode - Codex Authorization Successful</title>
    <style>
      body {
        font-family:
          system-ui,
...
<html>
  <head>
    <title>BetterCode - Codex Authorization Failed</title>
    <style>
      body {
        font-family:
          system-ui,
...
export async function CodexAuthPlugin(input: PluginInput, options: CodexAuthPluginOptions = {}): Promise<Hooks> {
  ...
  return {
    ...
    "chat.headers": async (input, output) => {
      ...
      output.headers.originator = "bettercode"
      output.headers["User-Agent"] = `bettercode/${InstallationVersion} (${os.platform()} ${os.release()}; ${os.arch()})`
