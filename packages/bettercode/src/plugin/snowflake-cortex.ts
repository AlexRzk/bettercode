import type { Hooks, PluginInput } from "@bettercode/plugin"
...
function authHeaders() {
  return {
    ...
    "User-Agent": `bettercode/${InstallationVersion}`,
  }
}
...
<html>
  <head><title>BetterCode - Snowflake Authorization Successful</title></head>
  <body style="font-family: system-ui; display:flex; align-items:center; justify-content:center; height:100vh; margin:0; background:#111; color:#eee;">
    <div style="text-align:center; max-width:36rem; padding:2rem;">
      ...
      <p>You can close this window and return to BetterCode.</p>
    </div>
...
<html>
  <head><title>BetterCode - Snowflake Authorization Failed</title></head>
  <body style="font-family: system-ui; display:flex; align-items:center; justify-content:center; height:100vh; margin:0; background:#111; color:#eee;">
        ...
        return {
          ...
          async fetch(requestInput: RequestInfo | URL, init?: RequestInit) {
            ...
            const prepareRequest = () => {
              ...
              headers.set("User-Agent", `bettercode/${InstallationVersion}`)
      ...
      methods: [
        {
          ...
          async authorize(inputs = {}) {
            ...
            return {
              url,
              instructions:
                "Complete Snowflake sign-in in your browser. BetterCode will capture the OAuth callback and store the bearer token automatically.",
