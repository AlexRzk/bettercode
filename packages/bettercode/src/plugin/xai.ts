...
export function buildAuthorizeUrl(
  ...
  // clients. `referrer=bettercode` lets xAI attribute bettercode-originated
...
<html>
  <head>
    <title>BetterCode - xAI Authorization Successful</title>
    <style>
      body {
        font-family:
          system-ui,
...
<html>
  <head>
    <title>BetterCode - xAI Authorization Failed</title>
    <style>
      body {
        font-family:
          system-ui,
...
async function startOAuthServer(): Promise<{ port: number; redirectUri: string }> {
  ...
  await new Promise<void>((resolve, reject) => {
    ...
    server.listen(OAUTH_PORT, OAUTH_HOST, () => {
      ...
      // behavior and crash the entire bettercode process. Matches the silent-
