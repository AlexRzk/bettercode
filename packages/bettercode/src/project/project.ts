...
import { ProjectDirectoryTable, ProjectTable } from "@bettercode/core/project/sql"
import { ProjectDirectories } from "@bettercode/core/project/directories"
...
import { which } from "@bettercode/core/util/which"
...
import { AbsolutePath, NonNegativeInt, optionalOmitUndefined } from "@bettercode/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@bettercode/Project") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(ProjectVcs))(Flag.BETTERCODE_FAKE_VCS)
