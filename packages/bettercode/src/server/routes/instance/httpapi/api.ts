...
export const RootHttpApi = HttpApi.make("bettercode-root")
...
export const InstanceHttpApi = HttpApi.make("bettercode-instance")
...
export const BetterCodeHttpApi = HttpApi.make("bettercode")
