...
>()("@bettercode/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@bettercode/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.BETTERCODE_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.BETTERCODE_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-bettercode-directory"] || process.cwd()
}
