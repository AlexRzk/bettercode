import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@bettercode/llm"
...
// Move this extraction into @bettercode/llm when Copilot is handled by the native runtime.
