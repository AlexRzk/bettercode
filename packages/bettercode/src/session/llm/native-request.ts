import type { JsonSchema, LLMRequest, ProviderMetadata } from "@bettercode/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@bettercode/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @bettercode/llm request objects from bettercode's session/AI SDK-shaped data.
  return LLM.request({
