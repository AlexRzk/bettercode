...
import { Slug } from "@bettercode/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@bettercode/llm"
...
import { PartTable, SessionTable } from "@bettercode/core/session/sql"
...
import { NonNegativeInt, optionalOmitUndefined } from "@bettercode/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".bettercode", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@bettercode/Session") {}
