...
import type * as SDK from "@bettercode/sdk/v2"
...
import { SessionShareTable } from "@bettercode/core/share/sql"
...
const disabled = process.env["BETTERCODE_DISABLE_SHARE"] === "true" || process.env["BETTERCODE_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@bettercode/ShareNext") {}
