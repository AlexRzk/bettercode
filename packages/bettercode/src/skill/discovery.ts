...
import { httpClient, path } from "@bettercode/core/effect/layer-node-platform"
...
export class Service extends Context.Service<Service, Interface>()("@bettercode/SkillDiscovery") {}
