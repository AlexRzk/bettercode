...
import { path } from "@bettercode/core/effect/layer-node-platform"
...
import type { ProjectV2 } from "@bettercode/core/project"
...
export class Service extends Context.Service<Service, Interface>()("@bettercode/Worktree") {}
  ...
  Effect.gen(function* () {
    ...
    const candidate = Effect.fn("Worktree.candidate")(function* (input: {
      ...
      for (const attempt of Array.from({ length: MAX_NAME_ATTEMPTS }, (_, i) => i)) {
        ...
        const branch = input.detached ? undefined : `bettercode/${name}`
