...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/bettercode.git")).toEqual({ owner: "sst", repo: "bettercode" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/bettercode")).toEqual({ owner: "sst", repo: "bettercode" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/bettercode.git")).toEqual({ owner: "sst", repo: "bettercode" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/bettercode")).toEqual({ owner: "sst", repo: "bettercode" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/bettercode.git")).toEqual({ owner: "sst", repo: "bettercode" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/bettercode")).toEqual({ owner: "sst", repo: "bettercode" })
})
