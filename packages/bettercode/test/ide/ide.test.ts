...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders BETTERCODE_CALLER", () => {
    process.env["BETTERCODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode BETTERCODE_CALLER", () => {
    process.env["BETTERCODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown BETTERCODE_CALLER", () => {
    process.env["BETTERCODE_CALLER"] = "unknown"
