...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips bettercode-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-bettercode-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-bettercode-directory")).toBeNull()
      expect(result.get("x-bettercode-workspace")).toBeNull()
