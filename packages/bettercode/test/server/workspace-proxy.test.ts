...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips bettercode-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-bettercode-directory"]).toBeUndefined()
      expect(forwarded["x-bettercode-workspace"]).toBeUndefined()
