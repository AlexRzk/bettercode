...
const stateLayer = Layer.effectDiscard(
  Effect.gen(function* () {
    const original = {
      BETTERCODE_EXPERIMENTAL_WORKSPACES: Flag.BETTERCODE_EXPERIMENTAL_WORKSPACES,
    }
    ...
    yield* Effect.addFinalizer(() =>
      Effect.promise(async () => {
        Flag.BETTERCODE_EXPERIMENTAL_WORKSPACES = original.BETTERCODE_EXPERIMENTAL_WORKSPACES
        await resetDatabase()
      }),
    )
  }),
