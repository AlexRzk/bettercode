...
import desktopAppIcon from "../../asset/lander/bettercode-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://bettercode.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>bettercode.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g bettercode")}>
                <code>
                  npm i -g <strong>bettercode</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g bettercode")}>
                <code>
                  bun add -g <strong>bettercode</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/bettercode")}>
                <code>
                  brew install <strong>anomalyco/tap/bettercode</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S bettercode")}>
                <code>
                  paru -S <strong>bettercode</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask bettercode-desktop")}>
                <code>
                  brew install --cask <strong>bettercode-desktop</strong>
                </code>
                <CopyStatus />
              </button>
