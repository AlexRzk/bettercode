...
import { Database, eq, and, isNull } from "@bettercode/console-core/drizzle/index.js"
import { BillingTable, LiteTable } from "@bettercode/console-core/schema/billing.sql.js"
        ...
        {(sub) => (
          <section class={styles.root}>
            ...
            <div data-slot="beta-notice">
              ...
              <a href={language.route("/docs/providers/#bettercode-go")} target="_blank" rel="noopener noreferrer">
