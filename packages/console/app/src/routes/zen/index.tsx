...
import compareVideo from "../../asset/lander/bettercode-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/bettercode-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="bettercode:auth" content={loggedin() ? "true" : "false"} />
