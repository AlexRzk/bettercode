...
export class Service extends Context.Service<Service, Interface>()("@bettercode/v2/FileSystem/Search") {}
...
export const locationLayer = Layer.unwrap(
  Effect.sync(() => (Flag.BETTERCODE_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)),
)
