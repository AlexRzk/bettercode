...
import type { EffectDrizzleSqlite } from "@bettercode/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@bettercode/ProjectDirectories") {}
