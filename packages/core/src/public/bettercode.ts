export * as BetterCode from "./bettercode"
...
/** Intentional public native API for Effect applications embedding BetterCode. */
export class Service extends Context.Service<Service, Interface>()("@bettercode/public/BetterCode") {}
...
// TODO: Add BetterCode.create(...) as the Promise facade over the same native API semantics.
