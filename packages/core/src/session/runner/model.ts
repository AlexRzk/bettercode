...
import { type Model } from "@bettercode/llm"
import * as AnthropicMessages from "@bettercode/llm/protocols/anthropic-messages"
import * as OpenAICompatibleChat from "@bettercode/llm/protocols/openai-compatible-chat"
import * as OpenAIResponses from "@bettercode/llm/protocols/openai-responses"
import { Auth, type AnyRoute } from "@bettercode/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@bettercode/v2/SessionRunnerModel") {}
