...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@bettercode/llm"
...
export class Service extends Context.Service<Service, Interface>()("@bettercode/v2/ToolRegistry") {}
