...
export function registerWslIpcHandlers(controller: WslServersController) {
  ...
  ipcMain.handle("wsl-servers-probe-bettercode", (_event: IpcMainInvokeEvent, name: string) =>
    controller.probeOpencode(requireWslIpcString("distro", name)),
  )
  ipcMain.handle("wsl-servers-install-bettercode", (_event: IpcMainInvokeEvent, name: string) =>
...
function registerUnavailableWslIpcHandlers() {
  ...
  ipcMain.handle("wsl-servers-probe-bettercode", unavailable)
  ipcMain.handle("wsl-servers-install-bettercode", unavailable)
