...
class Database extends Context.Service<Database, DatabaseShape>()("@bettercode/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@bettercode/example/UserStore") {
