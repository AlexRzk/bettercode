...
export const TypeId: TypeId = "~@bettercode/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@bettercode/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@bettercode/effect-sqlite-node/NodeSqliteClient")
