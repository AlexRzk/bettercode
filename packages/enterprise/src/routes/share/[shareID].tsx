import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@bettercode/sdk/v2"
import { SessionTurn } from "@bettercode/ui/session-turn"
import { SessionReview } from "@bettercode/ui/session-review"
import { DataProvider } from "@bettercode/ui/context"
import { FileComponentProvider } from "@bettercode/ui/context/file"
import { WorkerPoolProvider } from "@bettercode/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@bettercode/ui/logo"
import { IconButton } from "@bettercode/ui/icon-button"
import { ProviderIcon } from "@bettercode/ui/provider-icon"
import { iife } from "@bettercode/core/util/iife"
import { Binary } from "@bettercode/core/util/binary"
import { NamedError } from "@bettercode/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import NotFound from "../[...404]"
import { Tabs } from "@bettercode/ui/tabs"
import { MessageNav } from "@bettercode/ui/message-nav"
import { FileSSR } from "@bettercode/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@bettercode/ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/bettercode-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })

          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | BetterCode</Title>
              </Show>
              <Meta name="description" content="bettercode - The AI coding agent built for the terminal." />
                        ...
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            ...
                            <div class="flex gap-3 items-center">
                              <IconButton
                                as={"a"}
                                href="https://github.com/anomalyco/bettercode"
                                target="_blank"
                                icon="github"
                                variant="ghost"
                              />
                              <IconButton
                                as={"a"}
                                href="https://bettercode.ai/discord"
                                target="_blank"
                                icon="discord"
                                variant="ghost"
                              />
