...
Schema-first LLM core for bettercode. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@bettercode/llm"
import { OpenAI } from "@bettercode/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@bettercode/llm/providers"
