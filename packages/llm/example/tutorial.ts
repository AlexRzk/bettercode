...
import { LLM, LLMClient, Message, ProviderID, Tool, ToolRuntime } from "@bettercode/llm"
import { Route, Auth, Endpoint, Framing, Protocol, RequestExecutor, WebSocketExecutor } from "@bettercode/llm/route"
...
const rawOverlayExample = LLM.request({
  ...
  http: {
    ...
    headers: { "x-bettercode-tutorial": "1" },
    query: { debug: "1" },
  },
})
