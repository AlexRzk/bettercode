...
- Effect plugins import `@bettercode/plugin/v2/effect`, not `@bettercode/core`.
- Public domain values use generated `@bettercode/sdk` types.
...
- Define `PluginHost` domain capabilities in `@bettercode/plugin/v2/effect`.
