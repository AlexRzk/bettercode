import bettercodeWordmarkDark from "../asset/logo-ornate-dark.svg"
...
export const githubLink = {
  ...
  apiHref: "https://api.github.com/repos/anomalyco/bettercode",
  label: "GitHub",
  fallbackStars: "150K",
  ariaLabel: "Star BetterCode on GitHub",
}
export const themePreferences = ["dark", "light", "system"] as const
export const themeStorageKey = "bettercode:stats-theme"
    ...
    <header data-component="top" data-menu-open={menuOpen() ? "true" : undefined}>
      <div data-slot="header-bar">
        ...
        <div data-slot="header-actions">
          ...
          <a data-slot="header-button" data-variant="contrast" href="https://bettercode.ai/">
            <strong>Try BetterCode</strong>
          </a>
          <button
...
function BetterCodeMark() {
  return (
    <svg data-slot="bettercode-mark" width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">
...
export function Footer(props: {
  ...
  const legal = [
    { href: "https://bettercode.ai/legal/terms-of-service", label: "Terms of service" },
    { href: "https://bettercode.ai/legal/privacy-policy", label: "Privacy policy" },
  ]
  const connect = [
    { href: "mailto:hello@bettercode.ai", label: "Contact us" },
    { href: "https://bettercode.ai/discord", label: "Community" },
    { href: "https://x.com/bettercode", label: "X" },
    githubLink,
  ...
  return (
    <footer data-component="footer">
      ...
      <div data-slot="footer-grid">
        <a data-slot="footer-mark" href="https://bettercode.ai" aria-label="BetterCode home">
          <BetterCodeMark />
        </a>
    ...
    <div data-component="subscribe-modal" role="dialog" aria-modal="true" aria-labelledby="subscribe-title">
      ...
      <div data-slot="modal-panel">
        <div data-slot="modal-brand">
          <img data-slot="modal-logo" src={bettercodeWordmarkDark} alt="BetterCode" />
        ...
        <div data-slot="modal-body">
          <div data-slot="modal-intro">
            <h2 id="subscribe-title">BetterCode Newsletter</h2>
            <p>
