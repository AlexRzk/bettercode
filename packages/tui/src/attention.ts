...
import defaultSoundPath from "@bettercode/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@bettercode/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@bettercode/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@bettercode/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@bettercode/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@bettercode/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "bettercode"
const DEFAULT_PACK_ID = "bettercode.default"
const KV_SOUND_PACK = "attention_sound_pack"
const TITLE_LIMIT = 80
const MESSAGE_LIMIT = 240
const BUILTIN_PACK: RegisteredSoundPack = {
  id: DEFAULT_PACK_ID,
  name: "BetterCode Default",
  builtin: true,
  sounds: {
