...
import { getOpencodeModeStack, BETTERCODE_BASE_MODE, OpencodeKeymapProvider, registerOpencodeKeymap } from "../src/keymap"
...
test("mode-less bindings stay active when bettercode mode changes", async () => {
