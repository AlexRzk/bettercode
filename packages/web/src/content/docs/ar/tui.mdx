---
title: TUI
description: استخدام واجهة المستخدم TUI في BetterCode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر BetterCode واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل BetterCode إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة BetterCode في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى BetterCode. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من BetterCode. _الأسماء المستعارة_: `/quit`, `/q`
...
هذا منفصل عن `bettercode.json`، الذي يضبط سلوك الخادم ووقت التشغيل.
...
- `leader_timeout` - يتحكم في مدة انتظار BetterCode بعد الضغط على leader key. القيمة الافتراضية `2000`.
...
- `sound_pack` - sound pack ID المراد استخدامه. القيمة الافتراضية `bettercode.default`.
