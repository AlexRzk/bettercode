...
Kreiraj `.bettercode/commands/test.md`:
...
Možete dodati prilagođene komande kroz BetterCode konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom BetterCode [config](/docs/config):
...
- Globalno: `~/.config/bettercode/commands/`
- Po projektu: `.bettercode/commands/`
...
BetterCode uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
