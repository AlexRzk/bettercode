...
Brug den til at bygge integrasjoner og kontrollere bettercode programmatisk.
...
Opret en forekomst av bettercode:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `bettercode.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av bettercode, kan du oprete en klientforekomst for at koble til den:
