...
Agentferdigheter lar BetterCode oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går BetterCode opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
...
BetterCode viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `bettercode.json`:
