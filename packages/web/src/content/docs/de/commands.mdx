...
Erstellen Sie `.bettercode/commands/test.md`:

```md title=".bettercode/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die BetterCode-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem BetterCode [config](/docs/config):

```json title="bettercode.jsonc" {4-12}
{
...
- Global: `~/.config/bettercode/commands/`
- Pro Projekt: `.bettercode/commands/`

```markdown title="~/.config/bettercode/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".bettercode/commands/component.md"
---
...
```md title=".bettercode/commands/create-file.md"
---
...
```md title=".bettercode/commands/analyze-coverage.md"
---
...
```md title=".bettercode/commands/review-changes.md"
---
...
```md title=".bettercode/commands/review-component.md"
---
...
BetterCode enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
