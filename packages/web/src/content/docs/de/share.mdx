---
title: Teilen
description: Teile BetterCode-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu BetterCode-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht BetterCode Folgendes:
...
BetterCode hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt BetterCode den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`bettercode.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du bettercode in deiner Organisation einsetzt.
