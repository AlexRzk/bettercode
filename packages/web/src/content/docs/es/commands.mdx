...
Crear `.bettercode/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración BetterCode o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su BetterCode [config](/docs/config):
...
- Por proyecto: `.bettercode/commands/`
...
bettercode incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
