...
Crea `.bettercode/commands/test.md`:
...
Puoi aggiungere comandi personalizzati tramite la config di BetterCode o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di BetterCode:
...
- Globale: `~/.config/bettercode/commands/`
- Per progetto: `.bettercode/commands/`
...
bettercode include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
