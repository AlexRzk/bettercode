...
`.bettercode/commands/test.md` を作成します。
...
カスタムコマンドは、BetterCode 設定を通じて、または `commands/` ディレクトリに Markdown ファイルを作成することによって追加できます。

---

### JSON

BetterCode [設定](/docs/config)で `command` オプションを使用します:
...
- グローバル: `~/.config/bettercode/commands/`
- プロジェクトごと: `.bettercode/commands/`
...
BetterCode には、`/init`、`/undo`、`/redo`、`/share`、`/help` などのいくつかの組み込みコマンドが含まれています。 [詳細はこちら](/docs/tui#commands)。
