...
Opprett `.bettercode/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom BetterCode-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i BetterCode [config](/docs/config):
...
- Per prosjekt: `.bettercode/commands/`
...
BetterCode inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
