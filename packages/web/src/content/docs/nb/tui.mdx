---
title: TUI
description: Bruke bettercode-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

BetterCode gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre BetterCode starter TUI for gjeldende katalog.
...
Når du bruker BetterCode TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til BetterCode. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt BetterCode. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `bettercode.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge BetterCode venter etter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `bettercode.default`.
