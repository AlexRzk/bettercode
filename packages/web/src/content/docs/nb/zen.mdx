---
title: Zen
description: Utvalgt liste over modeller levert av BetterCode.
---
...
BetterCode Zen er en liste over testede og verifiserte modeller levert av BetterCode-teamet.

Zen fungerer som enhver annen leverandør i BetterCode. Du logger inn på BetterCode Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med BetterCode.
:::
...
BetterCode Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

BetterCode Zen fungerer som enhver annen leverandør i BetterCode.

1. Du logger inn på **<a href={console}>BetterCode Zen</a>**, legger til
   faktureringsdetaljene dine og kopierer API-nøkkelen din.
2. Du kjører kommandoen `/connect` i TUI, velger BetterCode Zen og limer inn API-nøkkelen din.
...
[modell-id](/docs/config/#models) i BetterCode-konfigurasjonen din
bruker formatet `bettercode/<model-id>`. For eksempel, for GPT 5.5, ville du
brukt `bettercode/gpt-5.5` i konfigurasjonen din.
...
- DeepSeek V4 Flash Free er tilgjengelig på BetterCode i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- MiMo-V2.5 Free er tilgjengelig på BetterCode i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- North Mini Code Free er tilgjengelig på BetterCode i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Nemotron 3 Ultra Free er tilgjengelig på BetterCode i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på BetterCode i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
...
Vi opprettet BetterCode Zen for å:
...
4. Ha **ingen lock-in** ved å la deg bruke det med enhver annen kodeagent. Og alltid la deg bruke enhver annen leverandør med BetterCode også.
