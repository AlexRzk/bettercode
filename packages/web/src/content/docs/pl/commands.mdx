...
Utwórz `.bettercode/commands/test.md`:
...
Możesz zdefiniować polecenia w `bettercode.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji bettercode:
...
- Globalnie: `~/.config/bettercode/commands/`
- Na projekt: `.bettercode/commands/`
...
bettercode zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
