---
title: Udostępnianie
description: Udostępnij swoje rozmowy dotyczące bettercode.
---

Funkcja udostępniania bettercode umożliwia tworzenie publicznych linków do konwersacji bettercode, dzięki czemu możesz współpracować z członkami zespołu lub uzyskać pomoc od innych.
...
Kiedy udostępniasz rozmowę, bettercode:
...
bettercode obsługuje trzy tryby udostępniania, które kontrolują sposób udostępniania rozmów:

---

### Ręczne (domyślne)

Domyślnie bettercode korzysta z ręcznego trybu udostępniania. Sesje nie są udostępniane automatycznie, ale możesz je udostępnić ręcznie za pomocą polecenia `/share`:
...
Aby wymusić to w całym zespole dla danego projektu, dodaj go do `bettercode.json` w swoim projekcie i sprawdź w Git.
...
[Dowiedz się więcej](/docs/enterprise) o używaniu bettercode w Twojej organizacji.
