---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala bettercode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

bettercode zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie bettercode uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI bettercode, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do bettercode. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij bettercode. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `bettercode.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo BetterCode czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `bettercode.default`.
