---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez BetterCode.
---
...
BetterCode Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół BetterCode.

Zen działa jak każdy inny dostawca w BetterCode. Logujesz się do BetterCode Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z BetterCode.
:::
...
BetterCode Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

BetterCode Zen działa jak każdy inny dostawca w BetterCode.

1. Logujesz się do **<a href={console}>BetterCode Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz BetterCode Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji BetterCode używa formatu
`bettercode/<model-id>`. Na przykład dla GPT 5.5 użyjesz w konfiguracji
`bettercode/gpt-5.5`.
...
- DeepSeek V4 Flash Free jest dostępny w BetterCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- MiMo-V2.5 Free jest dostępny w BetterCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- North Mini Code Free jest dostępny w BetterCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Ultra Free jest dostępny w BetterCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w BetterCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
Stworzyliśmy BetterCode Zen, aby:
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w BetterCode także dowolnego innego dostawcy.
