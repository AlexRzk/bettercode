...
สร้าง `.bettercode/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ BetterCode:
...
- ระดับผู้ใช้ (Global): `~/.config/bettercode/commands/`
- ระดับโปรเจ็กต์: `.bettercode/commands/`
...
BetterCode มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
