...
`.bettercode/commands/test.md` oluştur:
...
bettercode işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

bettercode [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/bettercode/commands/`
- Proje başına: `.bettercode/commands/`
...
bettercode, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
