---
title: Özel Araçlar
description: LLM'un bettercode'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. bettercode'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.bettercode/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/bettercode/tools/` içine yerleştirerek.
