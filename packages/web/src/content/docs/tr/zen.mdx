---
title: Zen
description: bettercode tarafından sağlanan seçilmiş modeller listesi.
---
...
BetterCode Zen, BetterCode ekibi tarafından test edilip doğrulanmış modellerin bir listesidir.

Zen, BetterCode'daki diğer sağlayıcılar gibi çalışır. BetterCode Zen'de oturum açıp API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve BetterCode kullanmak için buna ihtiyacınız yoktur.
...
:::tip
BetterCode ile iyi çalışan seçili bir model ve sağlayıcı grubunu test ettik.
:::
...
BetterCode Zen, bu modellere erişmenizi sağlayan bir AI ağ geçididir.

---

## Nasıl çalışır

BetterCode Zen, BetterCode'daki diğer sağlayıcılar gibi çalışır.

1. **<a href={console}>BetterCode Zen</a>**'de oturum açın, faturalandırma bilgilerinizi ekleyin ve API anahtarınızı kopyalayın.
2. TUI'de `/connect` komutunu çalıştırın, BetterCode Zen'i seçin ve API anahtarınızı yapıştırın.
...
BetterCode yapılandırmanızdaki [model id](/docs/config/#models) `bettercode/<model-id>` biçimini kullanır. Örneğin, GPT 5.5 için yapılandırmanızda `bettercode/gpt-5.5` kullanırsınız.
...
- DeepSeek V4 Flash Free, sınırlı bir süre için BetterCode'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- MiMo-V2.5 Free, sınırlı bir süre için BetterCode'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- North Mini Code Free, sınırlı bir süre için BetterCode'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3 Ultra Free, sınırlı bir süre için BetterCode'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Big Pickle, sınırlı bir süre için BetterCode'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
BetterCode Zen'i şunlar için oluşturduk:
...
4. Başka herhangi bir kodlama ajanıyla kullanmanıza izin vererek **kilitlenme olmamasını** sağlamak. Ayrıca BetterCode ile her zaman başka herhangi bir sağlayıcıyı da kullanabilmenizi sağlamak.
