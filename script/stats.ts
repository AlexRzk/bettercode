...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/bettercode/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/bettercode...\n")
...
console.log("Fetching npm all-time downloads for bettercode...\n")
const npmDownloads = await fetchNpmDownloads("bettercode")
